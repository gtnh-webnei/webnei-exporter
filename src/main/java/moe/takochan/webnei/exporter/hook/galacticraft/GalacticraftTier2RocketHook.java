...
/**
 * Galacticraft {@code ItemRendererTier2Rocket}（GalacticraftMars 子模块 mars）：{@code transform} 内读
 * {@code Sys.getTime() / 30F % 360F} 作为绕 Y 轴旋转角度。完整周期 = 360 × 30 = {@code 10800} 单位。
 *
 * <p>
 * 配套 mixin：{@code mixins.galacticraft.ItemRendererTier2RocketMixin} 把 {@code Sys.getTime()} 重定向到
 ...
 */
public final class GalacticraftTier2RocketHook extends AbstractPlayerTickHook {
    ...
    protected boolean matchesItem(ItemStack stack) {
        ...
        return renderer instanceof ItemRendererTier2Rocket;
    }
