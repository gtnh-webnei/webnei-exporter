...
/**
 * GalaxySpace {@code ItemRendererRocket}：{@code transform} 内读 {@code Sys.getTime() / 30F % 360F + 45}
 * 作为绕 Y 轴旋转角度。完整周期 = 360 × 30 = {@code 10800} 单位。
 *
 * <p>
 * 配套 mixin：{@code mixins.galaxyspace.ItemRendererRocketMixin} 把 {@code Sys.getTime()} 重定向到
 ...
 */
public final class GalaxySpaceRocketHook extends AbstractPlayerTickHook {
    ...
    protected boolean matchesItem(ItemStack stack) {
        ...
        return renderer instanceof ItemRendererRocket;
    }
